(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let n = e.r(7269).createRenderSearchParamsFromClient;
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let n = e.r(96728).createRenderParamsFromClient;
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
        ...
        switch (n.type) {
          ...
          case "validation-client":
            return (function (t, r, n) {
              var a;
              let { createExhaustiveSearchParamsProxy: o } = e.r(66296);
    ...
    function v(t, r, n, a) {
      ...
      if (n.validationSamples) {
        let { createExhaustiveSearchParamsProxy: a } = e.r(66296),
  ...
  (e, t, r) => {
          ...
          case "request":
            if (s.asyncApiPromises && s.validationSamples)
              return (function (t, r, n, a, o) {
                let { createExhaustiveParamsProxy: i } = e.r(66296),
    ...
    function O(t, r, n) {
      let { createExhaustiveParamsProxy: a } = e.r(66296);
      return Promise.resolve(
        a(
          t,
  ...
  (e, t, r) => {
    ...
    function l({ Component: t, serverProvidedParams: r }) {
      ...
      if ("u" < typeof window) {
        let r,
          a,
          { createSearchParamsFromClient: o } = e.r(28456);
        r = o(c);
        let { createParamsFromClient: i } = e.r(33984);
        return (a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r });
      }
      {
        let { createRenderSearchParamsFromClient: r } = e.r(71526),
          a = r(c),
          { createRenderParamsFromClient: o } = e.r(68307),
          i = o(u);
  ...
  (e, t, r) => {
    ...
    function i({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ("u" < typeof window) {
        let { createParamsFromClient: a } = e.r(33984),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
      {
        let { createRenderParamsFromClient: a } = e.r(68307),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
    }
